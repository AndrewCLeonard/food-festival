$(document).ready(function () {
	...
	if (window.location.href.indexOf("schedule") > -1) {
						...
						onClick: () =>
							(function (e) {
								...
								localStorage.setItem(
									"currentEvent",
									JSON.stringify({ title: e.title, subtitle: t, description: e.description, image: e.image })
								),
		...
		const c = e("div", { class: "container mt-5" }, e("div", { class: "card mb-5" }, e("h5", { class: "card-header" }, "Day 1"), ...a(s.slice(0, 3)))),
			l = e("div", { class: "container" }, e("div", { class: "card mb-5" }, e("h5", { class: "card-header" }, "Day 2"), ...a(s.slice(3, 6)))),
			d = e("div", { class: "container" }, e("div", { class: "card mb-5" }, e("h5", { class: "card-header" }, "Day 3"), ...a(s.slice(6, 9))));
		n.appendChild(c), n.appendChild(l), n.appendChild(d);
	}
	if (window.location.href.indexOf("event") > -1) {
		const a = JSON.parse(localStorage.getItem("currentEvent")) || { title: "Title Placeholder", subtitle: "", description: "" },
			...
			o = e(
				...
				e(
					"div",
					{ class: "card mb-3" },
					e("img", { class: "card-img-top", style: "width: 5px", src: a.image || "https://via.placeholder.com/350x150" }),
					e(
						"div",
						{ class: "card-body" },
						...
						e("a", { class: "btn btn-primary", href: "tickets.html" }, "Buy Tickets")
					)
				)
			);
		i.appendChild(o);
